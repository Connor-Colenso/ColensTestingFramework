...
public class MainController {
    ...
    @FXML private StackPane TestConfigStackPane;
    @FXML private ListView<String> TestConfigListView;
    @FXML private ListView<String> Gamerules;
    @FXML private ListView<String> TestSettings;
    @FXML private ListView<String> Commands;
    @FXML private ListView<Procedure> procedureViewBox;
    @FXML private ListView<String> rawProcedureViewBox;
        ...
        if (currentTest != null) {
            ...
            if (currentTest.has(TEST_CONFIG)) {
                ...
                for (Map.Entry<String, JsonElement> entry : gamerulesJson.entrySet()) {
                    gamerules.add(entry.getKey() + " : " + entry.getValue().getAsBoolean());
                }
